...
Silahkan tekan tombol *List Menu* dibawah.Jika kamu ingin melihat seluruh fitur bot ini silahkan ketik *Allmenu*.
`
}
exports.listMenu = (time, salam, pushname, prefix) => {
    return `*Selamat ${salam}* ${pushname}
*⌚Time Server : ${time}*
*📚 List-Menu ALVYN-BOTZ :*
...
╭─❒ 「 Primbon 」
├ ${prefix}nomorhoki 859193578139
├ ${prefix}artimimpi Mimpinya
├ ${prefix}artinama Nama Kamu
├ ${prefix}ramaljodoh Kamu, 16, 1, 2004, Pacar, 22, 2, 2004
├ ${prefix}ramaljodohbali Kamu, 16, 1, 2004, Pacar, 22, 2, 2004
├ ${prefix}suamiistri Kamu, 16, 1, 2004, Pacar, 22, 2, 2004
├ ${prefix}ramalcinta Kamu, 16, 1, 2004, Pacar, 22, 2, 2004
├ ${prefix}cocoknama Kamu, 16, 1, 2004
├ ${prefix}pasangan Kamu|Pacar
├ ${prefix}jadiannikah 6, 12, 2020
├ ${prefix}sifatusaha 28, 12, 2021
├ ${prefix}rezeki 16, 1, 2004
├ ${prefix}pekerjaan 16, 1, 2004
├ ${prefix}nasib 16, 1, 2004
├ ${prefix}penyakit 16, 1, 2004
├ ${prefix}tarot 16, 1, 2004
├ ${prefix}fengshui Kamu, 1, 2004
├ ${prefix}haribaik 16, 1, 2004
├ ${prefix}harisangar 16, 1, 2004
├ ${prefix}harisial 16, 1, 2004
├ ${prefix}nagahari 16, 1, 2004
├ ${prefix}arahrezeki 16, 1, 2004
├ ${prefix}peruntungan 16, 1, 2004, 2022
├ ${prefix}weton 16, 1, 2004
├ ${prefix}karakter Kamu, 16, 1, 2004
├ ${prefix}keberuntungan Kamu, 16, 1, 2004
├ ${prefix}memancing 16, 1, 2004
├ ${prefix}masasubur 12, 1, 2022, 28 (Note :  hari pertama menstruasi, siklus)
├ ${prefix}zodiak 16, 1, 2004
╰❒ ${prefix}shio [query]
...
*── 「 RULES BOT 」 ──*
👋 Hai User ALVYN-BOTZ
Rules - Ketentuan penggunaan ALVYN-BOTZ
❎ Dilarang overspam!
❎ Dilarang eksploitasi bot!
❎ Dilarang menjual bot ini!
...
├ *Gender* :
├ *Askot* :
╰❒ *Patuhi rules grup ya kak* ~`
}
exports.leave = () =>{
	return`*Yah kok out 😣 Semoga tenang di alam sana ya kak:v*
*Goodbye*`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode : https://github.com/alvyn-vengeance/Alphabot-Md9
`
}
...
wa.me/${ownernomer} (ALVYN)
Bayar melalui : 📲 0859193578139 (Pulsa/DANA)
Atau Scan Kode QR diatas
Terimakasih sudah mau sewa
    `
}
